...
export const defaultSettings = {
    ...
    banner: {
        ...
        heroNameScrim: true,
        // เปิดแล้ว: อวตารวงกลมเล็กของ ST เองก็จะหมุนตามรูปเดียวกับ banner ของข้อความนั้น (ใช้คอลเลกชันที่ผูก
        // ไว้ชุดเดียวกันเป๊ะ ไม่ใช่คอลเลกชันแยก) เป็นอิสระจาก banner.enabled — ปิด banner แต่ยังหมุนอวตารได้
        // ใช้ได้เฉพาะตอนมีคอลเลกชันผูกไว้จริงเท่านั้น (auto-fallback ไม่เข้าเงื่อนไข เพราะรูปนั้นก็มาจาก
        // อวตารเดิมอยู่แล้ว หมุนกลับไปหาตัวเองไม่มีความหมาย)
        syncAvatar: false,
    },
